    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-10">
          <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-6 max-w-4xl mx-auto">
            Transform Your
            <br />
            Consultation Notes
          </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            ...
            communications from your consultation notes
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm transition-transform duration-200 group-hover:-translate-y-1">
        ...
        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
          <p>Security-first | Private | Professional</p>
        </div>
      </div>
    </main>
  );
